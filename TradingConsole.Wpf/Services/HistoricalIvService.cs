    ...
    public class HistoricalIvService
    {
        ...
        private HistoricalIvDatabase LoadDatabase()
        {
            ...
            try
            {
                ...
                var db = JsonConvert.DeserializeObject<HistoricalIvDatabase>(json);
        ...
        /// <summary>
        /// Records the daily high and low IV for a given instrument key.
        /// </summary>
        ...
        /// <summary>
        /// Gets the high and low IV over the last 90 days for a specific key.
        /// </summary>
